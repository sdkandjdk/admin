...
var NBSP_RX = /&nbsp;/g;
var BULLET_LIST_WITH_ORDERED_NUM_RX = /^(\s*\*\s+\d+)\./g;
/**
 * Class Convertor
...
function hasMsoListStyle(node) {
  ...
  return styleAttr ? MSO_STYLE_LIST_RX.test(styleAttr) : false;
}
...
function convertMsoParagraphsToList(container) {
  var paras = [];
  dom["a" /* default */].findAll(container, MSO_CLASS_NAME_LIST_PARA).filter(function (node) {
    return hasMsoListStyle(node);
