    ...
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin: 0 0 0 14px" class="table-operator">
          <a-button @click="handleAdd(1)" type="primary">添加科室</a-button>
          <a-button @click="handleAdd(2)" type="primary">添加下级</a-button>
          <a-button type="primary" icon="download" @click="handleExportXls('科室信息')">导出</a-button>
        ...
        <div style="background: #fff;padding-left:16px;height: 100%; margin-top: 5px">
          ...
          <a-input-search @search="onSearch" style="width:100%;margin-top: 10px" placeholder="请输入科室名称"/>
          <!-- 树-->
          <a-col :md="10" :sm="24">
            <template>
        ...
        <a-tab-pane tab="基本信息" key="1" >
          <a-card :bordered="false" v-if="selectedKeys.length>0">
            <a-form-model ref="form" :model="model" :rules="validatorRules">
              <a-form-model-item :labelCol="labelCol"  :wrapperCol="wrapperCol"  label="科室名称" prop="departName" >
                <a-input placeholder="请输入科室/科室名称" v-model="model.departName"/>
              </a-form-model-item>
              <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="上级科室" prop="parentId">
              ...
              <a-form-model-item  :labelCol="labelCol" :wrapperCol="wrapperCol" label="科室编码" prop="orgCode">
                <a-input disabled placeholder="请输入科室编码" v-model="model.orgCode"/>
              </a-form-model-item>
              <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="科室类型" prop="orgCategory">
          ...
          <a-card v-else >
            <a-empty>
              <span slot="description"> 请先选择一个科室! </span>
            </a-empty>
          </a-card>
        </a-tab-pane>
        <a-tab-pane tab="科室权限" key="2" forceRender>
  ...
  export default {
    ...
    data() {
      return {
        ...
        validatorRules: {
          departName: [{required: true, message: '请输入科室/科室名称!'}],
    ...
    methods: {
        ...
        this.$refs.form.validate((ok, err) => {
          if (ok) {
            if (!this.currSelected.id) {
              this.$message.warning('请点击选择要修改科室!')
              return
            }
      ...
      handleAdd(num) {
        if (num == 1) {
          ...
          if (!key) {
            this.$message.warning('请先点击选中上级科室！')
            return false
          }
